...
function HTMLfruitProduct(con){
    let URL = `../img/fruits/fruit${con}.PNG`;
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-cente">
                        <div class="btn-group">
                            <button type="button" onclik="cart2('${FRUIT[con-1].name}',
                            '${FRUIT[con-1].price}','${URL}','${con}','${btn}')"
                            class="btn btn-sm btn-outline-secondary">
                            <a style="color:inherit;" href="/cart">BUY</a>
                            </button>
                            <button id="${btn}" type="button" onclik="cart('${FRUIT[con-1].name}',
                            '${FRUIT[con-1].price}','${URL}','${con}','${btn}')"
                            class="btn btn-sm btn-outline-secondary">
                           Add to cart
                            </button>
...
function HTMLjuicetProduct(con){
    let URL = `../img/juice/juice${con}.PNG`;
        ...
        <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-cente">
                        <div class="btn-group">
                            <button type="button" onclik="cart2('${JUICE[con-1].name}',
                            '${JUICE[con-1].price}','${URL}','${con}','${btn}')"
                            class="btn btn-sm btn-outline-secondary">
                            <a style="color:inherit;" href="/cart">BUY</a>
                            </button>
                            <button id="${btn}" type="button" onclik="cart('${JUICE[con-1].name}',
                            '${JUICE[con-1].price}','${URL}','${con}','${btn}')"
                            class="btn btn-sm btn-outline-secondary">
                           Add to cart
                            </button>
...
function HTMLsaladProduct(con){
    let URL = `../img/salads/salads${con}.PNG`;
        ...
        <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-cente">
                        <div class="btn-group">
                            <button type="button" onclik="cart2('${SALAD[con-1].name}',
                            '${SALAD[con-1].price}','${URL}','${con}','${btn}')"
                            class="btn btn-sm btn-outline-secondary">
                            <a style="color:inherit;" href="/cart">BUY</a>
                            </button>
                            <button id="${btn}" type="button" onclik="cart('${SALAD[con-1].name}',
                            '${SALAD[con-1].price}','${URL}','${con}','${btn}')"
                            class="btn btn-sm btn-outline-secondary">
                           Add to cart
                            </button>
...
(()=>{
    ...
    for(let index = 1; index <= 3; index++){
        juiceDIV.innerHTML+=`${HTMLjuicetProduct(index)}`;
